...
if volume_endpoint = get_access_endpoint("cinder-api", "cinder", "api")
  admin_volume_endpoint = get_access_endpoint("cinder-api", "cinder", "admin-api")
  internal_volume_endpoint = get_access_endpoint("cinder-api", "cinder", "internal-api")
