...
template "/etc/cinder/cinder.conf" do
  ...
  variables(
    ...
    "solidfire_mvip" => node["cinder"]["storage"]["solidfire"]["mvip"],
    "solidfire_username" => node["cinder"]["storage"]["solidfire"]["username"],
    "solidfire_password" => node["cinder"]["storage"]["solidfire"]["password"],
